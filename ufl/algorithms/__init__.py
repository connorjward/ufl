...
__all__ = [
    ...
    "strip_variables",
    "strip_form_arguments",
    "attach_form_arguments",
    "post_traversal",
...
from ufl.algorithms.transformer import strip_form_arguments
from ufl.algorithms.transformer import attach_form_arguments
